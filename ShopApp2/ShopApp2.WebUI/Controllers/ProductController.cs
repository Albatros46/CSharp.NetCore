    ...
    public class ProductController : Controller
    {
        ...
        //Burada tanımladığımız list i view de belirtilen List.cshtml de model tanımlarken List olarak tanımlayacağız.
             var products = new List<Product>() { 
                new Product{Name="iPhone X Max",Price=12000,Description="Çok İyi Telefon",isApproved=true},
                new Product{Name="Samsung Galaxy S 10",Price=6000,Description="İyi Telefon",isApproved=true},
                new Product{Name="iPhone 8 Plus",Price=9000,Description="İyi Telefon",isApproved=false},
